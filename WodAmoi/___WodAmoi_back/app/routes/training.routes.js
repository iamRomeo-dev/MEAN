module.exports = app => {
  const mesMvts = require("../controllers/training.controller.js");
  ...
  // Recuperation de tout les mvts publiés !!!!!!!
  router.get("/published", mesMvts.findAllPublished);
  ...
  app.use('/api/WodAmoi_entrainements', router);
};